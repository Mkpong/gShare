...
class StatusSync:
    ...
    async def _reflect_phase(self, sess: Session, phase: str, ev: OperatorStatusEvent) -> None:
        ...
        # A reaper-initiated Terminating names WHY ("max-runtime-exceeded"); the follow-up
        # Terminated arrives from the finalizer with no message, so the reason must stick here
