...
async def list_node_pools(
    ...
    # Bound before the branch: the visibility filter below runs under the same condition, but a
    # reader (and the static analyser) cannot prove that, and a future edit that splits the two
    # branches would hit an UnboundLocalError at request time.
    group_orgs: dict[str, str] = {}
