...
export function AdminOrgs() {
  ...
  const cols: Column<Org>[] = [
    ...
    { key: 'group_count', header: t('admin.orgs.colGroups'), sortBy: (o) => o.group_count ?? 0, align: 'center', hideOnMobile: true, headerClassName: 'whitespace-nowrap px-6', cellClassName: 'px-6', render: (o) => <span className="gs-num">{o.group_count ?? 0}</span> },
    { key: 'user_count', header: t('admin.orgs.colUsers'), sortBy: (o) => o.user_count ?? 0, align: 'center', hideOnMobile: true, headerClassName: 'whitespace-nowrap px-6', cellClassName: 'px-6', render: (o) => <span className="gs-num">{o.user_count ?? 0}</span> },
    {
      key: 'status',
    ...
    { key: 'created_at', header: t('common.created'), align: 'center', headerClassName: 'whitespace-nowrap px-6', cellClassName: 'px-6', sortBy: (o) => (o.created_at ? new Date(o.created_at).getTime() : 0), hideOnMobile: true, render: (o) => <span className="whitespace-nowrap"><Timestamp value={o.created_at} /></span> },
    {
      key: 'actions', header: '', align: 'right', headerClassName: 'whitespace-nowrap',
      render: (o) => (
