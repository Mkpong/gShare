...
function PresetsTab() {
  ...
  const actionsCol: Column<ResourcePreset> = {
    ...
    align: 'right',
    headerAlign: 'center',
    headerClassName: 'whitespace-nowrap', header: t('admin.resources.colActions'), render: (p) => (
      <div className="flex flex-nowrap gap-2">
  ...
  const computeColumns: Column<ResourcePreset>[] = [
    { key: 'name', header: t('admin.resources.colPreset'), headerClassName: 'whitespace-nowrap', cellClassName: 'whitespace-nowrap', render: (p) => <b>{p.name}</b> },
    { key: 'spec', header: t('admin.resources.colSpec'), align: 'center', headerClassName: 'w-full', render: (p) => (
